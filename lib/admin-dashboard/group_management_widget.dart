        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              ...
              _deleteGroup(groupId); // Delete the group if confirmed
            },
      ...
      children: [
        ...
        ElevatedButton(
          onPressed: _loadingGroups
              ...
              : () {
                  setState(() {
                    _showGroupList = !_showGroupList; // Toggle group list visibility
                  });
                },
        ...
        if (_loadingGroups)
          ...
          _buildGroupList(isDarkMode), // Show group list when toggled
      ],
    );
  }
        ...
        return Card(
          ...
          child: ListTile(
            ...
            trailing: IconButton(
              ...
              onPressed: () => _confirmDeleteGroup(group['id']), // Prompt to delete the group
            ),
          ),
        );
      },
